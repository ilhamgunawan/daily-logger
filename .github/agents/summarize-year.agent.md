---
name: summarize-year
description: Generate an annual summary (logs/<year>/summary_<year>.md) from a year's finalized daily entries (and that year's monthly/weekly summaries where useful), following this repo's summary rules. Use for "summarize the year", "generate annual summary", "annual summary for <year>", or when a specific year is named.
---
