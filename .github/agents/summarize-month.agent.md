...
description: Generate a monthly summary (logs/<year>/<month>/summary_<year>-<month>.md) from a month's finalized daily entries (and that month's weekly summaries where useful), following this repo's summary rules. Use for "summarize the month", "generate monthly summary", "monthly summary for <year>-<month>", or when a specific month is named.
---
